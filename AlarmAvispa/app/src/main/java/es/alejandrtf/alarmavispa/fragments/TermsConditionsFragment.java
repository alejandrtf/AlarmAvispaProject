...
public class TermsConditionsFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        showWebViewAlertDialogTermsConditions();

    }


    /**
     * Method shows an alert dialog that load a Terms and Conditions Web inside using a webview
     */
    private void showWebViewAlertDialogTermsConditions() {


        AlertDialog.Builder ad = new AlertDialog.Builder(getContext());
        ad.setTitle(getString(R.string.terms_conditions));
        ...
        wv.loadUrl(Constants.URL_TERMS_CONDITIONS_WEB);
        wv.setWebViewClient(new WebViewClient() {
            @Override
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                // open all links in my webview and avoid going out
                String url_filter = Constants.URL_TERMS_CONDITIONS_WEB;
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(getContext())
                        .setTitle(getString(R.string.error_loading_terms_conditions_web_title))
                        .setMessage(getString(R.string.error_loading_terms_conditions_web_message)+": "+description)
        ...
        if(Internet.isInternetConectionActive(getContext()))
            ...
            textError.setText(R.string.error_conection_internet_terms_conditions);
        ...
        ad.setPositiveButton(R.string.accept, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                Navigation.findNavController(getActivity(), R.id.my_nav_host_fragment).navigate(R.id.action_termsConditionsFragment_to_notifySightingFragment);
